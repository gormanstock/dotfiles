...
class BazelPackageTreeItem {
    ...
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            const queryResult = yield new bazellib_1.BazelQuery(configuration_1.getDefaultBazelExecutablePath(), this.workspaceInfo.bazelWorkspacePath, `//${this.packagePath}:all`, [], true).queryTargets([], /* sortByRuleName: */ true);
