    ...
    provideDocumentSymbols(document, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (workspaceInfo === undefined) {
                vscode.window.showWarningMessage("Bazel BUILD Symbols unavailable as currently opened file is not in " +
                    "a Bazel workspace");
                return [];
            }
            const queryResult = yield bazellib_1.getTargetsForBuildFile(configuration_1.getDefaultBazelExecutablePath(), workspaceInfo.bazelWorkspacePath, document.uri.fsPath);
