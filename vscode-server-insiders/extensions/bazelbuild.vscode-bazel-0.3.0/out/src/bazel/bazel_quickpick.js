...
const bazel_query_1 = require("./bazellib/bazel_query");
/**
...
function queryWorkspaceQuickPickTargets(workspaceInfo, query) {
    return __awaiter(this, void 0, void 0, function* () {
        const queryResult = yield new bazel_query_1.BazelQuery(configuration_1.getDefaultBazelExecutablePath(), workspaceInfo.bazelWorkspacePath, query, []).queryTargets();
...
function queryWorkspaceQuickPickPackages(workspaceInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        const packagePaths = yield new bazel_query_1.BazelQuery(configuration_1.getDefaultBazelExecutablePath(), workspaceInfo.bazelWorkspacePath, "...:*", []).queryPackages();
        const result = [];
