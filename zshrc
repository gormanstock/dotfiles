...
alias port-dev-backend="awsk8 ot-dev-eks && k port-forward deployments/django-backend -n ot-dev-service 8000:8000"
alias port-staging-backend="awsk8 ot-dev-eks && k port-forward deployments/django-backend -n ot-staging-service 8000:8000"
